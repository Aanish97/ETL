...
class Etl:
    ...
    def de_duplication(self):
            ...
            data_1.to_excel('DeDuplicationData.xlsx')
            return
    ...
    def date_format_standardization(self):
            ...
            dataF_2.to_excel('DateFormatStandardization.xlsx')
            return
    ...
    def derived_attribute_age(self):
            ...
            dataF_3.to_excel('DerivedAttributeAge.xlsx')
            return
    ...
    def split_single_attribute(self):
            ...
            dataF_8.to_excel('SplitSingleAttribute.xlsx')
            return
    ...
    def merge_name_field(self):
            ...
            dataF_4.to_excel('MergeNameField.xlsx')
            return
    ...
    def decode_gender_field(self):
            ...
            dataF_5.loc[(dataF_5.Gender == 'female') | (dataF_5.Gender == 'Female') | 
                    ...
                    , 'Gender'] = 'female'  
            dataF_5.to_excel('DecodeGenderField.xlsx')
            return
